...
function ListEstudianteComponent() {
    ...
    return (
        <div>
            ...
            <div className="row">
                <button className="btn btn-primary" onClick={handleClickAgregarEstudiante}>
                    Agregar Estudiante
                </button>
            </div>
            <br />
                    ...
                    <tbody>
                        {estudiantes.map(estudiante => (
                            <tr key={estudiante.idEstudiante}>
                                ...
                                <td>
                                    <button onClick={() => handleClickViewEstudiante(estudiante.idEstudiante)} className="btn btn-info">
                                        View
                                    </button>
                                    <button style={{ marginLeft: "10px" }} onClick={() => handleClickUpdateEstudiante(estudiante.id)} className="btn btn-info">
                                        Update
                                    </button>
                                    <button style={{ marginLeft: "10px" }} onClick={() => handleClickDeleteEstudiante(estudiante.id)} className="btn btn-danger">
                                        Delete
                                    </button>
                                </td>
                            </tr>
